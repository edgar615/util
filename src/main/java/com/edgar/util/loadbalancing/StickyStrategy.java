 ...
 */
class StickyStrategy implements ServiceProviderStrategy {

  private final ServiceProviderStrategy masterStrategy;
  ...
  public StickyStrategy(ServiceProviderStrategy masterStrategy) {
