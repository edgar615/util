...
public class Device implements Persistable<Integer> {
  ...
  public Map<String, Object> toMap() {
   ...
   /* START Do not remove/edit this line. CodeGenerator will preserve any code between start and
   end tags.*/
  /* END Do not remove/edit this line. CodeGenerator will preserve any code between start and end
	tags.*/
