...
public class Validations {
     ...
     */
    public static void validate(final Map<String, Object> params, final Multimap<String, Rule> rules) {
     ...
     * @param rules    校验规则的map对象，map的键值是需要校验的属性名，值是校验规则的集合
     */
    public static void validate(final Multimap<String, String> multiMap, final Multimap<String, Rule> rules) {
        Multimap<String, String> error = ArrayListMultimap.create();
        if (multiMap == null) {
            return;
        }
