...
public class Query {
   ...
   * @return Query
   */
  public static Query fromStr(String queryString) {
    Query query = new Query();
    SearchHelper.fromStr(queryString)
            .forEach(c -> query.addCriteria(c));
    return query;
  }

  public List<Criteria> criterias() {
    return ImmutableList.copyOf(criterias);
  }
   ...
   * @return Query
   */
  public Query notEqualsTo(String field, Object value) {
   ...
   * @return Query
   */
  public Query contains(String field, Object value) {
    Preconditions.checkNotNull(value);
   ...
   * @return Query
   */
  public Query startsWith(String field, Object value) {
    Preconditions.checkNotNull(value);
   ...
   * @return Query
   */
  public Query endsWtih(String field, Object value) {
    Preconditions.checkNotNull(value);
   ...
   * @return Query
   */
  public Query in(String field, List<Object> values) {
   ...
   * @return Query
   */
  public Query equalsTo(String field, Object value) {
    Preconditions.checkNotNull(value);
   ...
   * @return Query
   */
  private Query addCriteria(String field, Op op) {
   ...
   * @return Query
   */
  private Query addCriteria(String field, Op op, Object value) {
    MorePreconditions.checkNotNullOrEmpty(field, "field cannot be null");
    Preconditions.checkNotNull(value, "value cannot be null");
    check(op, value);
    addCriteria(new Criteria(field, op, value));
    return this;
  }
   ...
   * @return Query
   */
  private Query addCriteria(String field, Op op, Object value1, Object value2) {
    MorePreconditions.checkNotNullOrEmpty(field, "field cannot be null");
    ...
    check(op, value1);
    check(op, value2);
    addCriteria(new Criteria(field, op, value1, value2));
    return this;
  }
