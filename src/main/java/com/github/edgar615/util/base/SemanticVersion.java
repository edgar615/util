...
public class SemanticVersion implements Comparable<SemanticVersion> {
  ...
  public SemanticVersion(String version) {
    ...
    if (parts.length >= PARTS_MIN) {
      try {
        ...
        throw new IllegalArgumentException("Version number is not semantic [" + version
            + "]! Should be in the format d.d.d. See http://semver.org");
      }
    } else {
  ...
  private static boolean isAtLeastMajorMinorImpl(SemanticVersion version, int majorVersion,
      int minorVersion) {
