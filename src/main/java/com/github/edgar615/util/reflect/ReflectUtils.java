...
// No thread context class loader -> use class loader of this class.
  ...
  /**
   * Execute the call within the given class loader... handle setting / reverting to previous class
   * loader in a safe manner.
   *
  ...
  /**
   * Computes the signature of a method. Note that if 2 methods are declared in different classes or
   * interfaces then I1.m and I2.m are different but they can still have the same signature...
   *
   * @param m method
  ...
  /**
   * Utility which extract the interfaces implemented by o: it goes up the chain of inheritance to
   ...
   * javadoc of <code>Class.isAssignableFrom</code> method. Every time I need to use this method I
   * read and reread the javadoc 25 times without being clear of what should be the order of each
   * parameter.
   * <p>
